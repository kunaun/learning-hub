        ...
        <h2 className="mt-8 text-xl font-bold leading-relaxed">{question.question}</h2>
          ...
          <div className="mt-6 grid gap-3">
            {question.choices.map((choice) => {
              ...
              return (
                <button key={choice} onClick={() => chooseAnswer(choice)} disabled={selected !== null} className={cls}>
                  {choice}
                </button>
              );
            })}
          ...
          {selected !== null && <MascotFeedback correct={correct} />}

          {selected !== null && (
            <div className={`mt-6 rounded-xl p-4 ${correct ? "bg-green-50 text-green-800" : "bg-red-50 text-red-800"}`}>
          ...
          {selected !== null && (
            <button onClick={next} className="mt-6 w-full rounded-xl bg-blue-600 py-3 font-semibold text-white hover:bg-blue-700">
